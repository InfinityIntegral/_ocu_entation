...
void SGDMSgmlGeneration::generateSgml(){
    ...
    const SGXString modulesPath = SGXFileSystem::joinFilePaths(SGDMDocumentationParsing::sourcePath + "SGML_source", "modules");
    if(SGXFileSystem::folderExists(modulesPath) == true){SGXFileSystem::permanentDeleteFolder(modulesPath);}
    SGXFileSystem::createFolder(modulesPath);
...
void SGDMSgmlGeneration::generateForNextClass(){
    ...
    if(currentClass.className.length() > 11 && currentClass.className.substringLeft(11) == "@SG_MODULE "){
        ...
        SGXString moduleName = currentClass.className.substringRight(currentClass.className.length() - 11);
        ...
        SGXString targetFolder = SGXFileSystem::joinFilePaths(SGDMDocumentationParsing::sourcePath + "SGML_source", "modules");
